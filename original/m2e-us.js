...
//------------------------------------------
// From Laboratoire de Météorologie Dynamique 'Planetary Atmospheres' team
...
//------------------------------------------
    ...
    if (Math.round(ls*10)/10 < 10)
         {
         document.calc.mSolarLongitude.value = "00" + Math.round(ls*10)/10;
         }
    else
         {
         if (Math.round(ls*10)/100 < 10)
              {
              document.calc.mSolarLongitude.value = "0" + Math.round(ls*10)/10;
              }
         else
              {
              document.calc.mSolarLongitude.value = Math.round(ls*10)/10;
              }
         }
...
function fiveDigit(n)
{
	if (n < 0)
		return "-" + PadLeft(-n, 5, "0");
	else
		return PadLeft(n, 5, "0");
}
